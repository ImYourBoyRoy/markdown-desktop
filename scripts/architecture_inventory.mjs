...
const summaries = new Map(Object.entries({
  ...
  'src/components/RecentDocuments.svelte': 'Recent-document list with per-item removal, clear-history, and open actions.',
  ...
  'src/components/WorkspaceSidebar.svelte': 'Workspace open/scan controls, removable/clearable recent documents, search, and file navigation sidebar.',
  ...
  'src/lib/recent-documents.ts': 'Bounded recent-path normalization, recency ordering, and safe history removal.',
  ...
  'src/lib/updater.ts': 'Signed updater checks, retry-safe install lifecycle, readable notes, banner policy, and diagnostics.',
